...
get_biomass_and_nums_data_by_layer_and_length_function <- function(ship, survey, data_set_id, analysis_id, zones_list) {
  ...
  if (data_set_id != 0 & analysis_id != 0) {
    ...
    biomass_nums_query <- paste0(
      ...
      "layer, species_code, length, numbers, biomass, numbers_nm2, biomass_nm2 ",
