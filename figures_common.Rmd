...
<!-- Shelikof SST plot -->
```{r sst_shelikof, echo = FALSE, message=FALSE, warning=FALSE, dpi= 300, fig.height = 5, fig.width= 8.8, fig.cap = cap_text, fig.alt = cap_text, fig.id = 'shelikofSST'}
...
```{r plot_3_panel_maturity_umnak, echo = FALSE, message=FALSE, warning=FALSE, dpi= 300, fig.width=6, fig.height=7.5, fig.cap= cap_text, fig.alt = cap_text, fig.id = "umnakstraitmaturity"}
