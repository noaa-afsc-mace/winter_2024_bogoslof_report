...
historical_cover_sheet <- left_join(historical_selectivity_corrected_params, regions, by = c('surveys' = 'SURVEY')) %>%
  arrange(surveys) %>%
  select(- report_nums)

#historical_cover_sheet <- historical_selectivity_corrected_params
...
The table(s) above highlights the parameters used to grab historical data in the selectivity-corrected era. Check out the other parameters in the top of the script 'main_cruise_report_2022.Rmd' to be safe!  **Bold text will likely require updates as you edit the draft!**
