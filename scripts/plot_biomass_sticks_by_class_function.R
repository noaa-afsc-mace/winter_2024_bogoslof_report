...
plot_biomass_sticks_by_class_function <- function(biomass_data, region_name, rotation, max_bar_height, length_class_cutoff, age_class_cutoff = NULL) {
  ...
  # get a legend
  stick_legend <- MACEReports::build_stick_legend(stick_data = sticks)
  ...
  return(list(stickplot, region_name))
}
