...
umnak_maturity_summary_stage <- maturity_data[[2]]
...
umnak_most_common_male <- umnak_maturities_male$MATURITY[which.max(maturities_male$wt_percent)]
umnak_most_common_female <- umnak_maturities_female$MATURITY[which.max(maturities_female$wt_percent)]
...
# Samalga
# get the counts at each stage
samalga_maturity_summary_stage <- maturity_data[[2]]
...
samalga_most_common_male <- samalga_maturities_male$MATURITY[which.max(maturities_male$wt_percent)]
samalga_most_common_female <- samalga_maturities_female$MATURITY[which.max(maturities_female$wt_percent)]
