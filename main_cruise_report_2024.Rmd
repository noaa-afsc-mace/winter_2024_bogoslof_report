...
# Historical ages- unlike the lengths, these include every year in the time series
...
source("scripts/biomass_nums_plot_function.R")
source("scripts/biomass_nums_ages_plot_function.R")
...
<!--TODO:: intro, methods, results text! -->
...
<!--TODO:: check on common methods with Dave before calling this done! -->
...
<!--Compile the common results- cal results, etc  -->
```{r common_results, echo = FALSE, message=FALSE, warning=FALSE, results = 'asis'}
common_results <- knitr::knit_child("results_common.Rmd", quiet = TRUE)
cat(common_results)
```

<!--Compile the Shelikof-only results  -->
```{r shelikof_results, echo = FALSE, message=FALSE, warning=FALSE, results = 'asis'}
common_results <- knitr::knit_child("results.Rmd", quiet = TRUE)
cat(common_results)
```
...
# this compiles the common tables shared between Shumagins + Shelikof
...
<!--Shelikof Strait specific tables  -->
<!--TODO:: EVA/historical biomass table -->
```{r shelikof_tables, echo = FALSE, message=FALSE, warning=FALSE, results = 'asis'}
if (current_shelikof_survey == TRUE) {
  shelikof_tables_doc <- knitr::knit_child("tables_shelikof.Rmd", quiet = TRUE)
  cat(shelikof_tables_doc)
}
```
...
```{r shelikof_figures, echo = FALSE, message=FALSE, warning=FALSE, results = 'asis'}
if (current_shelikof_survey == TRUE) {
  shelikof_figures_doc <- knitr::knit_child("figures_shelikof.Rmd", quiet = TRUE)
  cat(shelikof_figures_doc)
}
```
\pagebreak
