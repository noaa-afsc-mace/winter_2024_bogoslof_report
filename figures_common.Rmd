...
```{r survey_trawls_overview, echo = FALSE, message=FALSE, warning=FALSE, dpi= 300, fig.height = 5, fig.width= 8.8, fig.cap = cap_text, fig.id = 'surveylocationmap'}
...
<!-- Shelikof SST plot -->
```{r sst_shelikof, echo = FALSE, message=FALSE, warning=FALSE, dpi= 300, fig.height = 5, fig.width= 8.8, fig.cap = cap_text, fig.id = 'shelikofSST'}
...
```{r get_sbe_data, echo = FALSE, message=FALSE, warning=FALSE, dpi= 300, fig.width=6, fig.height=7.5, fig.cap= cap_text, fig.id = "bogoslofsbe"}
...
```{r plot_3_panel_maturity_umnak, echo = FALSE, message=FALSE, warning=FALSE, dpi= 300, fig.width=6, fig.height=7.5, fig.cap= cap_text, fig.id = "umnakstraitmaturity"}
...
```{r plot_3_panel_maturity_samalga, echo = FALSE, message=FALSE, warning=FALSE, dpi= 300, fig.width=6, fig.height=7.5, fig.cap= cap_text, fig.id = "samalgamaturity"}
...
<!--bogoslof stickplot-->
```{r bogoslof_stickplot, echo = FALSE, message=FALSE, warning=FALSE, dpi= 300, fig.height = 5, fig.width= 8.8,  fig.cap= cap_text, fig.id = 'bogoslofsticks'}
cap_text <- c()
...
```{r plot_historical_barplots, echo = FALSE, message=FALSE, warning=FALSE, dpi= 300, fig.height = 5, fig.width= 8.8, fig.cap= cap_text, fig.id = "shelikofstraitbiocomps"}
...
```{r biomass_nums_shelikof_plot, echo = FALSE, message=FALSE, warning=FALSE, dpi= 300, fig.width=6, fig.height=4, fig.cap = cap_text, fig.id = 'bogoslofbionumslength'}
# start with a blank figure caption; add one if there's a survey
cap_text <- c()
...
```{r biomass_nums_bogoslof_ages_plot, echo = FALSE, message=FALSE, warning=FALSE, results='asis', dpi= 300, fig.width=6, fig.height=6, fig.cap = cap_text, fig.id = 'bogoslofbionumsages'}
# start with a blank figure caption; add one if there's a survey
cap_text <- c()
...
```{r historical_comparison, echo = FALSE, message=FALSE, warning=FALSE, dpi= 300, fig.width=6, fig.height= 8, fig.cap = cap_text, fig.id = 'ridgelineslength'}
# start with a blank figure caption; add one if there's a survey
cap_text <- c()
...
```{r historical_comparison_ages, echo = FALSE, message=FALSE, warning=FALSE, dpi= 300, fig.width=6, fig.height=8, fig.cap = cap_text, fig.id = 'agebubbles'}
# start with a blank figure caption; add one if there's a survey
...
```{r plot_length_at_age, echo = FALSE, message=FALSE, warning=FALSE,  dpi= 300, fig.width=6, fig.height=7, fig.cap = cap_text, fig.id= "shelikofstraitlwage"}
...
```{r plot_analysis_comparison, echo = FALSE, message=FALSE, warning=FALSE, suppress = T, fig.width=6, fig.height=7.5, fig.cap = cap_text, fig.id = 'analysiscomps'}
