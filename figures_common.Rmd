...
# build the caption
cap_text <- paste0("Pollock maturity in ", plot_region, ". A) Maturity composition for male and female pollock greater than 30 cm fork length (FL) within each stage; B) proportion mature (i.e. pre-spawning, spawning, or spent) by 1-cm size group for female pollock; C) gonadosomatic index for pre-spawning females (with historic survey mean ± 1 std. dev.). All maturity quantities are weighted by local pollock abundance.")
